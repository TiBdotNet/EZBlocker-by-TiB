...
namespace EZBlocker
{
    public partial class Main : Form
    {
                ...
                if (hook.IsRunning())
                {
                    if (hook.IsAdPlaying())
                    {
                        ...
                        if (lastMessage != message)
                        {
                            ...
                            //LogAction("/mute/" + artist); //Analytics is disabled on this version
                        }
                    }
                    else if (hook.IsPlaying() && !hook.WindowName.Equals("Spotify Free")) // Normal music
                    {
                        ...
                        if (lastMessage != message)
                        {
                            ...
                            StatusLabel.Text = message;
                            artistTooltip.SetToolTip(StatusLabel, artist);
                            // LogAction("/play/" + artist); //Analytics is disabled on this version
                        }
                    }
        ...
        private void CheckUpdate()
        {
            try
            {
                // Update are disabled on this version
        ...
        private void Heartbeat_Tick(object sender, EventArgs e)
        {
            ...
            {
                // LogAction("/heartbeat"); //Analytics is disabled on this version
            }
        }
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            //LogAction("/launch"); //Analytics is disabled on this version
        ...
        private void SkipAdsCheckbox_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LogAction("/settings/blockBanners/" + BlockBannersCheckbox.Checked.ToString()); //Analytics is disabled on this version
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex);
        ...
        private void StartupCheckbox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //LogAction("/settings/startup/" + StartupCheckbox.Checked.ToString()); //Analytics is disabled on this version
        }
        ...
        private void SpotifyCheckbox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.Save();
            //LogAction("/settings/startSpotify/" + SpotifyCheckbox.Checked.ToString()); //Analytics is disabled on this version
        }
        ...
        private void VolumeMixerButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //LogAction("/button/volumeMixer"); //Analytics is disabled on this version
            }
            catch (Exception)
            {
        ...
        private void WebsiteLink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            Process.Start(website);
            //LogAction("/button/website"); //Analytics is disabled on this version
        }
